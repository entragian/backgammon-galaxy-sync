...
// Galaxy's mid-2026 rewrite moved the API off play.backgammongalaxy.com. That old
// host still returns 200 (the SPA's HTML shell) instead of 404, so a stale value
// here surfaces as a JSON.parse failure in listPage rather than an HTTP error.
const DEFAULT_BASE_URL = 'api.backgammongalaxy.com';
